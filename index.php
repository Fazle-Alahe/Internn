...
$select_section = "SELECT * FROM section_title";
$select_section_result = mysqli_query($db_connect, $select_section);
$after_assoc_section = mysqli_fetch_assoc($select_section_result);



$select_section_1 = "SELECT * FROM section_title WHERE id=1";
$select_section_result_1 = mysqli_query($db_connect, $select_section_1);
$after_assoc_section_1 = mysqli_fetch_assoc($select_section_result_1);

$select_section_2 = "SELECT * FROM section_title WHERE id=2";
$select_section_result_2 = mysqli_query($db_connect, $select_section_2);
$after_assoc_section_2 = mysqli_fetch_assoc($select_section_result_2);

$select_section_3 = "SELECT * FROM section_title WHERE id=3";
$select_section_result_3 = mysqli_query($db_connect, $select_section_3);
$after_assoc_section_3 = mysqli_fetch_assoc($select_section_result_3);

$select_section_4 = "SELECT * FROM section_title WHERE id=4";
$select_section_result_4 = mysqli_query($db_connect, $select_section_4);
$after_assoc_section_4 = mysqli_fetch_assoc($select_section_result_4);

$select_section_5 = "SELECT * FROM section_title WHERE id=5";
$select_section_result_5 = mysqli_query($db_connect, $select_section_5);
$after_assoc_section_5 = mysqli_fetch_assoc($select_section_result_5);
		...
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="section-title text-center">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"><i class="ti-minus mr-2"></i><?= $after_assoc_section_1['sub_title']?></span>
					<h2 class="title"><?= $after_assoc_section_1['title']?></h2>
				</div>
			</div>
		</div>
...
<section class="section bg-gray" id="service" data-aos="fade-up">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="section-title text-center">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"><i class="ti-minus mr-2"></i><?= $after_assoc_section_2['sub_title']?></span>
					<h2 class="title"><?= $after_assoc_section_2['title']?></h2>
				</div>
			</div>
		</div>
...
<section class="section" id="portfolio" data-aos="fade-up">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="section-title text-center">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"><i class="ti-minus"></i><?= $after_assoc_section_3['sub_title']?></span>
					<h2 class="title"><?= $after_assoc_section_3['title']?></h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="section-title">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"> <i class="ti-minus mr-2"></i><?= $after_assoc_section_4['sub_title']?></span>
					<h1 class="title"><?= $after_assoc_section_4['title']?></h1>
				</div>
			</div>
		</div>
...
<section class="section" id="contact" data-aos="fade-up">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="section-title text-center">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"> <i class="ti-minus mr-2"></i><?= $after_assoc_section_5['sub_title']?></span>
					<h1 class="title"><?= $after_assoc_section_5['title']?></h1>
				</div>
			</div>
		</div>
